...
<body>
  ...
  <div id="loader-container" class="preloader-background">
    <div id="loader"></div>
  </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	//Inizializzazione character counter per textarea
      ...
      */
       ...
       */
       ...
       /*
        * Fix per evitare che la checkbox dentro l'input-field sia pi? piccola di un campo di input (testo o select) 
