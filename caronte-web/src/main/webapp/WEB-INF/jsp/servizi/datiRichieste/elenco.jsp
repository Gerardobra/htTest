...
<body>
	<div class="row">
		...
		<div class="nav-content">
			<ul class="tabs">
				<li class="tab col s6 m4 l3"><a target="_self" href="<spring:url value='/import/servizi/datiSian/elencoSian'/>">Dati tracciato fornitura Sian</a></li>
				<li class="tab col s6 m4 l3"><a class="active" href="#">Dati richieste eseguite/liquidate</a></li>
			</ul>
		</div>

		<div class="card col s12">
			<spring:url value="/import/servizi/datiRichieste/esportaDatiRichieste" var="formAction" />
			<form:form action="${formAction}" method="get" modelAttribute="ricercaDatiRichiesteForm" accept-charset="utf-8">
				<!--****************** FORM DI RICERCA ***************-->
				<div class="card-content col s12">
					<div class="card-title">
						Ricerca ed esporta dati richieste eseguite/liquidate
					</div>
					<div class="row">
						<div class="row">
							...
							<fmt:formatDate value="${ricercaDatiRichiesteForm.periodoA}" 
                pattern="dd/MM/yyyy" var="periodoA" />
							...
							<div class="card-panel hoverable">
								Selezionare il periodo di riferimento di cui si desidera
								generare e scaricare il file excel contenente i dati delle richieste
								e delle merci eseguite o liquidate nel periodo indicato.</div></div>
						</div>
						<div class="row">
							<div class="col s12 m6 l6">
								...
								<div class="row">
									...
									<div class="input-field col s12 m8 l6">
										...
										<label for="idNazioneDestinatario">Nazione Destinatario</label>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="input-field col s12 m8 l6">
										<form:select id="idDoganaArrivo" path="doganaArrivo"
											cssClass="validate">
											<form:option value="" label="Selezionare" />
											<form:options items="${ufficioDoganale}" itemValue="idUfficioDoganale" itemLabel="denomUfficioDoganale" />
										</form:select>
									...
									<div class="input-field col s12 m8 l6">
										<form:select id="idluogoOrigineMerce" path="luogoOrigineMerce" cssClass="validate">
											<form:option value="" label="Selezionare" />
										...
										<label for="idluogoOrigineMerce">Luogo di origine della	merce (Nazione)</label>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="input-field col s12 m8 l6">
										<form:select id="idLuogoRilascioCertificato" path="luogoRilascioCertificato" cssClass="validate">
											<form:option value="" label="Selezionare" />
											<form:options items="${ufficioDoganale}" itemValue="idUfficioDoganale" itemLabel="denomUfficioDoganale" />
										</form:select>
										<form:errors path="luogoRilascioCertificato" cssClass="error" />
										<label for="idLuogoRilascioCertificato">Luogo rilascio certificato</label>
									</div>
									<!------ INPUT::SPEDIZIONIERE ENTE -->
									<div class="input-field col s12 m8 l6">
										<form:input type="text" id="idSpedizioniereEnte" path="spedizioniereEnte" />
										<form:errors path="spedizioniereEnte" cssClass="error" />
										<label for="idSpedizioniereEnte">Operatore</label>
									</div>
								</div>
							</div>
							...
							<div class="col s12 m6 l6">
								<div class="row">
									<h5 class="header primary-color" style="font-weight: 300;">Filtri sul tracciato: Merci</h5>
									<div class="divider primary-color"></div>
								</div>
								<div class="row">
									<!------ INPUT::CODICE PRODOTTO -->
									<div class="input-field col s12 m8 l6">
										<form:input type="text" id="idNumeroRichiesta" path="numeroRichiesta" />
										<form:errors path="numeroRichiesta" cssClass="error" />
										<label for="idNumeroRichiesta">Numero Richiesta</label>
									</div>
									...
									<div class="input-field col s12 m8 l6">
										<form:select id="idClasseProdotto" path="classeProdotto"
											cssClass="validate">
											<form:option value="" label="Selezionare" />
											<form:options items="${listaClassi}" itemValue="idClasse" itemLabel="denomClasse" />
										</form:select>
								...
								<div class="row">
									<!------ AUTOCOMPLETE::GENERE PRODOTTO -->
									<div class="input-field col s12 m8 l6">
								    <form:input type="text" id="genere" path="genere" 
								      placeholder="Selezionare"  
								      class="autocomplete" autocomplete="off" />
		                <form:errors path="genere" cssClass="error" />
                    <label class="active" for="genere">Genere</label>
                    <form:input type="hidden" id="idGenere" path="idGenere" />
									</div>
								</div>
							</div>				
						</div>
					...
					<div class="card-action">
						<div class="row">
							...
							<div class="col s6 right-align">
								<button class="btn confirm waves-effect waves-light" type="submit" name="cercaSian">CERCA ED ESPORTA<i class="material-icons right">search</i></button>
							</div>
						</div>
					</div>
				</div>
	...
	<content tag="script"> 
	  <script>
	    $(document).ready(function() {
	    	$('#genere').on('input', function(event) {
