...
<body>
	<spring:url value="/controlli/controlloidentita/nuova" var="formAction" />	
		...
		<div class="card">
			<div class="card-header bg-primary-color white-text">
				<h3 class="card-title text-shadow uppercase-title title-padding">
					<b>NUOVO CONTROLLO DI IDENTITA'</b>
				</h3>
			</div>
						...
						<table id="tabellaSitiProduzione"
							...
							<tbody id="bodyTabellaSitiProduzione">
								<c:forEach var="sitoProd" items="${sitiProduzioneDb}">
									<tr>
										<td><a										
											href='<spring:url value="/controlli/controlloidentita/eliminaSitoProd/${sitoProd.idSitoProduzione}" />'
											title="Elimina"
