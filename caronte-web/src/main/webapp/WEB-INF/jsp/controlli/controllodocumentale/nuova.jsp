...
<body>
  <spring:url value="/controlli/controllodocumentale/nuova/salva" var="formAction" />
				...
				<div class="row">
				  ...
				  <li-lista><b>L'OP è autorizzato all'uso del passaporto:</b>
				                   <div class="row">													
									...
									<!-- 3.3.1 -->
									<ol style="list-style-type: decimal;">
									  <li-lista>L'autorizzazione al passaporto è adeguata alla tipologia di piante, prodotti vegetali e altri oggetti prodotte dall'OP:
					                       <div class="row">														
														  <label class="radio-inline">
