...
<body>
	<spring:url value="/controlli/campioni/modifica" var="formAction" />	
								...
								<div class="collapsible-body">
								  <div class="row col l12">
									<div class="input-field col s6 m4 l6">
										...
										<form:errors path="genereCampione" cssClass="error" />
									</div>
									<div class="input-field col s6 m4 l6">
								  ...
								  <div class="row col l12">	
									<div class="input-field col s6 m8 l4">
										...
										<label for="labelcodCampioneDal">Codice campione dal *</label>
									</div>
									<div class="input-field col s6 m8 l4">
										...
										<label for="labelcodCampioneAl">Codice campione al</label>
									</div>
									<div class="input-field col s6 m8 l4">
										...
										<label for="labeltipoCampione">Tipo campione *</label>
									</div>
								  </div>
								  <div class="row col l12">
									<div class="input-field col s6 m8 l4">
									...
									<div class="input-field col s6 m8 l4">
										<form:select id="tipologiaCampione" name="tipologiaCampione"
											...
											<form:option value="" label="Selezionare" selected="selected" disabled= "true" />
										...
										<label for="labeltipologiaCampione">Matrice campionata *</label>
									</div>
								  ...
								  <div class="row col l12">
									<div class="input-field col s12 m8 l4">
										...
										<label for="tempoImpiegato">Tempo impiegato (h,m)</label>
									</div>
								  ...
								  <div class="row col l12">
									<div class="input-field col s12 m8 l4">
										...
										<label for="labelorgNocAccertato">Organismo nocivo accertato</label>
									</div>
							...
							<tbody id="bodyTabellaCampioni">
								<c:forEach var="campione" items="${campioniDb}">
									<tr>
										...
										<td>
											<a href='<spring:url value="/controlli/modifica/campioni/eliminaCampione/${campione.idCampione}" />'
												title="Elimina"
				    ...
				    if (response) {
				    	...
				    	Swal.fire({
							...
							if (result.value) {
								  ...
								  window.location.href = '<spring:url value="/controlli/campioni/modifica"/>';
							}
						});
				    }
				}).fail(function(jqXHR, textStatus) {
