...
<body>
  <spring:url value="/controlli/misura/modifica/salva" var="formAction" />
  <form:form action="${formAction}" method="post" modelAttribute="nuovoControlloForm" accept-charset="utf-8">    
	<div class="card">
  			<div class="card-header bg-primary-color white-text">
				<h3 class="card-title text-shadow uppercase-title title-padding"><b>MODIFICA MISURA UFFICIALE</b></h3>
			</div>			
				...
				<div class="row col s12">
				  <div class="input-field col s4 m4 l12">			      
 					La Misura ufficiale viene disposta in relazione alle seguenti piante, prodotti vegetali, altri oggetti:	*	
 				                   <form:input type="text" id="noteMisuraDisp" path="noteMisuraDisp" cssClass="validate" required="required" maxlength="1000"/>
			...
			<div class="card-panel">	        	    
				...
				<div class="row">
				  <div class="input-field col s6 m4 l3">
						<form:select id="provNascitaCustode" path="idProvNascitaCustode"
					...
					<div class="input-field col s6 m4 l3">
						<form:select id="comNascitaCustode" path="idComNascitaCustode"
							cssClass="validate" required="required" disabled="">
							<form:option value="" label="Selezionare" />
				...
				<div class="row col l12">						
					<div class="input-field col s6 m4 l3">
						<form:select id="provResidCustode" path="idProvResidCustode"
							cssClass="validate" required="required" disabled="">
							<form:option value="" label="Selezionare" />
							<form:options items="${listaProvinceCustode}" itemValue="idProvincia"
								itemLabel="denomProvincia" />
					...
					<div class="input-field col s6 m4 l3">
						<form:select id="comResidCustode" path="idComResidCustode"
							cssClass="validate" required="required" disabled="">
							<form:option value="" label="Selezionare" />
