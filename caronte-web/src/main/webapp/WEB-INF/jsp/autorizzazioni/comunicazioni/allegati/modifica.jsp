...
<body>
	...
	<spring:url value="/autorizzazioni/comunicazioni/allegati/modifica" var="formAction" />
	<div class="card-panel">
		<div class="row">
			<p class="center-align" style="font-size: 20px; margin-bottom: 5px;">
				...
				per effettuare l'inoltro della domanda. La domanda viene scaricata durante 
				l'inoltro e non va allegata tra gli allegati</em>
			</p>
		</div>
	</div>
			...
			<spring:eval var="statoInBozza"	expression="T(it.aizoon.ersaf.util.CaronteConstants).STATO_COMUNICAZIONE_BOZZA" />	
  			<div class="card-content" style="padding-top:5px;">
				...
				<div class="row">
					<div class="card">
						<div class="card-header white-text">
							<h5 class="card-title bg-primary-color text-shadow title-padding"><b>Allegati per il completamento della domanda</b><b style="font-size: 50%;"> (dimensione massima 10 megabyte)</b></h5>
						</div>
						<div class="card-content">
							...
							<div class="row valign-wrapper" style="${allegato.flagMultiplo ? 'margin-bottom:0' : ''}">
										...
										<tbody data-obbligatorio="${allegato.flagObbligatorio}">
											...
											<tr>
												<td class="center input-field col s3">
													...
													<input type="hidden" name="idAllegato" value="${allegatoComunicazione.idAllegatoDomanda}" />									  			
													<input type="file" name="fileAllegato" value="" style="display:none" />
												</td>
												<td class="col s8" >
													<input type="text" id="descAllegato" name="descAllegato" value="${fn:escapeXml(allegatoComunicazione.descAllegato)}"/>
												</td>												
								...
								<div class="col s4">
									...
									<input type="hidden" name="idTipoAllegato" value="${allegato.idTipoAllegato}" />
									<input type="hidden" name="idAllegato" value="${empty allegato.listaAllegati ? '' : allegato.listaAllegati[0].idAllegatoDomanda}" />
								</div>
								<div class="col s8">
									<input type="text" id="descAllegato" name="descAllegato" value="${empty allegato.listaAllegati ? '' : allegato.listaAllegati[0].descAllegato}"  maxlength="200" />
								</div>
								</c:otherwise>
								</c:choose>
							</div>
       	...
       	<div class="row"> 
			<a href='<spring:url value="/autorizzazioni/comunicazioni/elenco"/>' class="btn waves-effect waves-light">TORNA ALLA RICERCA</a>
       	  	<div class="right" style="text-align: right">       	  	
	       		<c:if test="${(nuovaDomandaForm.abilitaInoltra && idTipoDomandaCancellazioneRUOP != nuovaDomandaForm.idTipoComunicazione) || not empty elencoTabMancanti}">						
					<a
							href='#'
							title="Inoltra"
				...
				<c:if test="${nuovaDomandaForm.abilitaInoltra && idTipoDomandaCancellazioneRUOP == nuovaDomandaForm.idTipoComunicazione && empty elencoTabMancanti}">						
					<a
				...
				<button class="btn confirm waves-effect waves-light " type="submit" name="datiComunicazione">SALVA</button>
	   	  	</div>
	   	</div>
