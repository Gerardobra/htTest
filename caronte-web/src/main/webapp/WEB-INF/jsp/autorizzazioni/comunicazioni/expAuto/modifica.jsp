...
<body>
	...
	<spring:url value="/autorizzazioni/comunicazioni/expAuto/modifica" var="formAction" />
	<spring:url value="/autorizzazioni/comunicazioni/expAuto/modifica" var="autorizzAction" />
