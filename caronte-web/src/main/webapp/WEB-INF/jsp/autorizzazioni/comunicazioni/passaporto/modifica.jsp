...
<body>
	<spring:url value="/autorizzazioni/comunicazioni/passaporto/modifica" var="formAction" />
	<spring:url value="/autorizzazioni/comunicazioni/passaporto/modifica" var="autorizzAction" />
	...
	<content tag="script"> 
        ...
        function eliminaTipologiaProd(link) {
			...
			function popolaListaGeneriZP(idGruppoZonaProtetta) {
				...
				console.log('popolaListaGeneri idGruppoZonaProtetta = '+idGruppoZonaProtetta);
