	...
	<div class="card">
			...
			<div id="anagrafica">
			  <div class="card-content">
				<div class="row">
					...
					<c:choose>
					<c:when test="${empty dettaglioDomanda.denomComuneEstNascita}">
					<div class="input-field col s6 m4 l3">
					...
					<c:choose>
					<c:when test="${empty dettaglioDomanda.denomComuneEstResid}">
					<div class="input-field col s6 m4 l3">
				...
				<div class="row">
					<div class="input-field col s6 m4 l3">
						<input type="text" id="denomTipoSpedizioniere" 
							value="${fn:escapeXml(dettaglioDomanda.denomTipoSpedizioniere)}" disabled="disabled" /> 
						<label for="denomTipoSpedizioniere">Tipo azienda</label>	
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="denomSpedizioniere" 
							value="${fn:escapeXml(dettaglioDomanda.denomSpedizioniere)}" disabled="disabled" /> 
						<label for="denomSpedizioniere">Ragione sociale</label>	
					</div>					
					<div class="input-field col s6 m4 l3">
						<input type="text" id="cuaa" 
							value="${fn:escapeXml(dettaglioDomanda.cuaa)}" disabled="disabled" />						
						<label for="cuaa">CUAA / Codice fiscale</label>
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="cuaa" 
							value="${fn:escapeXml(dettaglioDomanda.partitaIva)}" disabled="disabled" />						
						<label for="cuaa">Partita iva</label>
					  </div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="denomProvinciaSped" 
							value="${fn:escapeXml(dettaglioDomanda.denomProvinciaSped)}" disabled="disabled" /> 
						<label for="comSedeLegale">Provincia Sede Legale</label>	
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="denomComuneSped" 
							value="${fn:escapeXml(dettaglioDomanda.denomComuneSped)}"	disabled="disabled" /> 
						<label for="denomComuneSped">Comune Sede Legale</label>	
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="capSped" 
							value="${fn:escapeXml(dettaglioDomanda.capSped)}"	disabled="disabled" /> 
						<label for="capSped">Cap Sede Legale</label>	
					</div>													
					<div class="input-field col s6 m4 l3">
						<input type="text" id="indirizzoSped" 
							value="${fn:escapeXml(dettaglioDomanda.indirizzoSped)}" disabled="disabled" /> 
						<label for="indirizzoSped">Indirizzo sede legale (Es. Via Roma, 24)</label>	
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="telefonoSped" 
							value="${fn:escapeXml(dettaglioDomanda.telefonoSped)}" disabled="disabled" /> 
						<label for="telefonoSped">Numero telefono sede legale (Es. 0245673467)</label>	
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="cellSped" 
							value="${fn:escapeXml(dettaglioDomanda.cellSped)}" disabled="disabled" /> 
						<label for="cellSped">Numero cellulare sede legale (Es. 3471234567)</label>	
					</div>
					<div class="input-field col s6 m4 l3">
						<input type="text" id="faxSped" 
							value="${fn:escapeXml(dettaglioDomanda.faxSped)}" disabled="disabled" /> 
						<label for="faxSped">Numero fax sede legale (Es. 0298765432)</label>	
					</div>
					<div class="input-field col s6 m4 l3">
	    ...
	    <c:if test="${ idTipoDomandaVariazioneRUOP == nuovaDomandaForm.idTipoComunicazione || idTipoDomandaRUOP == nuovaDomandaForm.idTipoComunicazione}">		
			...
			<c:if test="${not empty listaModuli}">
				<div class="card-header white-text">
						<h5 class="card-title yellow darken-4 text-shadow title-padding"><b>I moduli proposti sono da scaricare, compilare e caricare nell'ultima colonna</b></h5>
					</div>
					<div class="card-content">
				...
				<div class="row">					
					...
					<div class="card-header white-text">
							<h5 class="card-title yellow darken-4 text-shadow title-padding"><b>Allegati</b></h5>
					</div>
					<div class="card-content">
			...
			<div id="gestione">
			 ...
			 <div class="card-panel">
					...
					<fmt:formatDate value="${dettaglioDomanda.dataRegistrazioneRuop}" pattern="dd/MM/yyyy" var="dataRegistrazioneRuop" />	
					<div class="input-field col s6 m4 l3">
					...
					<c:if test="${idTipoDomandaPassaporto == nuovaDomandaForm.idTipoComunicazione}">
						<div class="input-field col s12 m8 l6">
									<input type="text" id="tipologiaPassaporto"
										path="tipologiaPassaporto"	maxlength="20" />
									<errors path="tipologiaPassaporto" cssClass="error" />
									<label for="tipologiaPassaporto">Tipologia passaporto</label>
						</div>
						<div class="input-field col s12 m8 l4">
									<input type='text' id="dataAutorizzazionePassaporto"
										path="dataAutorizzazionePassaporto" cssClass="datepicker campiUt"
										/>
									<errors path="dataAutorizzazionePassaporto" cssClass="error" />
		...
		<div class="row">
			...
			<div class="right" style="text-align: right">			
					<c:if test="${abilitaConvalida}">
						<a
							href='<spring:url value="/autorizzazioni/comunicazioni/convalida/${idDomanda}"/>'
							title="Autorizza"
					...
					<c:if test="${abilitaRespingi}">
						<a
							href='<spring:url value="/autorizzazioni/comunicazioni/respingi/${idDomanda}"/>'
					...
					<!-- Creazione nuova comunicazione nel flusso -->
				    <c:if test="${nuovaDomandaForm.abilitaCreaNuovaDomandaFlusso}">						
							<a
								href='<spring:url value="/autorizzazioni/comunicazioni/crea/${nuovaDomandaForm.idDomanda}"/>'
								title="Crea nuova Domanda ${nuovaDomandaForm.descrBreveDomandaSuccessiva}"
								class="btn amber darken-1 waves-effect waves-light"
								style="display: inline-block"
							>NUOVA DOMANDA</a>							
	                </c:if>	
					...
					<c:if test="${idTipoDomandaRUOP == nuovaDomandaForm.idTipoComunicazione}"> 	
						<a		
						href='<spring:url value="/autorizzazioni/comunicazioni/cancella/${nuovaDomandaForm.idDomanda}"/>'							
		               	title="risposta esito istruttoria"
						class="btn amber darken-1 waves-effect waves-light right">
						CANCELLA DOMANDA												
					</a>
					</c:if>
					<c:if test="${abilitaAnnulla}">
						<a
							href='<spring:url value="/autorizzazioni/comunicazioni/annulla/${idDomanda}"/>'
							title="Annulla" class="btn red darken-4 waves-effect waves-light"
							style="display: inline-block; margin-right: 4px;" 
