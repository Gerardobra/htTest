...
<body>
	<spring:url value="/autorizzazioni/comunicazioni/impAuto/modifica" var="formAction" />
	<spring:url value="/autorizzazioni/comunicazioni/impAuto/modifica" var="autorizzAction" />
  				  	...
  				  	<div class="card-panel">
  				  	  <div class="row">
			            	...
			            	<div class="row" id="bloccoVociRadio">
									<c:forEach var="voceRadio" items="${vociRadioZoneProtette}">
										<div class=" col l8">
											<label> 
											   <form:radiobutton path="idVoceRadioZonaProtetta" value="${voceRadio.idVoce}" /> 
												<span>${voceRadio.descEstesa}</span>
											</label>
										</div>
									</c:forEach>
						...
						<c:forEach var="continente" items="${listaContinenti}" >		  				  	
			            		<div class="col s12 m2 l4">		            						            	
												<div class="input-field col s12 m8 l2">
													<label> 
													  <form:checkbox id="idVoceCheckContinenti" value="${continente.idVoce}" path="idVoceCheckContinenti" /> 
													  <span>${continente.descEstesa}</span>
													</label>												
												</div>																		
								</div>						
						</c:forEach>
