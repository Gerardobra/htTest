...
<body>
	<spring:url value="/autorizzazioni/comunicazioni/azienda/modifica" var="formAction" />
	<spring:url value="/autorizzazioni/comunicazioni/azienda" var="autorizzAction" />
	...
	<input type="hidden" id="chiamata" name="chiamata" value=""/>
		<div class="card">
			...
			<sec:authorize access="hasRole('SUPERUSER')" var="isSuperUser" />
  			...
  			<spring:eval var="cognomeAnag"	expression="nuovaDomandaForm.cognome" />
  			<spring:eval var="nomeAnag"	expression="nuovaDomandaForm.nome" />
  				...
  				<div class="row">
   	 				<div class="col s12">
      					<ul class="tabs">
        					...
        					<form:input type="hidden" id="idTipoComunicazione" path="idTipoComunicazione" value="${nuovaDomandaForm.idTipoComunicazione}"/>
        					<form:input type="hidden" id="idStatoComunicazione" path="idStatoComunicazione" value="${nuovaDomandaForm.idStatoComunicazione}"/>
        					<form:input type="hidden" id="domandaRuopConvalidataPresente" path="domandaRuopConvalidataPresente" value="${nuovaDomandaForm.domandaRuopConvalidataPresente}"/>
        	  ...
        	  <div class="card-panel">	
        		  ...
        		  <div class="input-field col s12 m8 l6">
						<!--<c:choose>
        		  		<c:when test="${idTipoDomandaPassaporto == nuovaDomandaForm.idTipoComunicazione}">
        		  			<form:select id="idAzienda" path="idAzienda"
								cssClass="validate" required="required" onchange="controllaDomandaRuop();">
								<form:option value="" label="Selezionare" />													
									<form:options items="${spedizionieriList}" itemValue="idSpedizioniere"
										itemLabel="denomSpedizioniere" />
							</form:select>
        		  		</c:when>
        		  		<c:otherwise>
        		  			<form:select id="idAzienda" path="idAzienda"
								cssClass="validate" required="required" onchange="visualizzaCampi();">
								<form:option value="" label="Selezionare" />													
									<form:options items="${spedizionieriList}" itemValue="idSpedizioniere"
										itemLabel="denomSpedizioniere" />
							</form:select>
				...
				<div class="row">
				    <div class="row col l12">
						<div class="input-field col s6 m4 l6">
							<form:select id="idTipoAzienda" path="idTipoAzienda"
								cssClass="validate myRequired azienda aziendaIndividuale" required="required" onchange="visualizzaNascondiCampi();">
								<form:option value="" label="Selezionare" />
								<form:options items="${listaTipiAzienda}" itemValue="idTipoSpedizioniere"
						...
						<div class="input-field col s6 m4 l6">
							<form:input type="text" id="codFiscaleAz"
								path="codFiscaleAz" cssClass="azienda aziendaIndividuale campiAz" data-length="16" required="required" />
					...
					<div class="row col l12">
						<div id="inputTipoSpedizioniereAltro" class="input-field col s6 m4 l6">
							<form:input type="text" id="tipoSpedizioniereAltro"
								path="tipoSpedizioniereAltro" cssClass="myRequired campiAz" data-length="100" required="required" />
							<form:errors path="tipoSpedizioniereAltro" cssClass="error" />
							<label for="tipoSpedizioniereAltro">Specificare tipologia Altro *</label>
						</div>					  
					  ...
					  <div id="inputDenomSpedizioniere" class="input-field col s6 m4 l12">
							<form:input type="text" id="denomAzienda"
								path="denomAzienda" cssClass="myRequired campiAz"
								required="required" maxlength="200" />
							<form:errors path="denomAzienda" cssClass="error" />
							<label for="denomAzienda">Denominazione/Ragione Sociale *</label>
						</div>
					</div>
					<div class="row col l12">							
						<div id="inputNomeAzienda" class="input-field col s6 m4 l6">
						  <form:input type="text" id="nomeAzienda"
										    cssClass="myRequired campiAz" required="required" onchange="aggiornaDenom();"
											path="nomeAzienda" />
					...
					<div class="hiddenField row col l12">
						<div class="input-field col s6 m4 l6">
							<form:select id="idProvinciaSedeLegale" path="idProvinciaSedeLegale"
								cssClass="validate myRequired campiAz" required="required" disabled=''>
								<form:option value="" label="Selezionare" />
								<form:options items="${listaProvinceSedeLegale}" itemValue="idProvincia"
						...
						<div class="input-field col s6 m4 l6">
							<form:select id="idComuneSedeLegale" path="idComuneSedeLegale"
								...
								<form:option value="" label="Selezionare" />
								<form:options items="${listaComuniSedeLegale}" itemValue="idComune"
					...
					<div class="hiddenField row col l12">
						<div class="input-field col s6 m4 l6">
						  <form:input type="text" id="capSedeLegale" required="required" path="capSedeLegale" cssClass="myRequired campiAz" />
						  <form:errors path="capSedeLegale" cssClass="error" />
						  <label id="labelCap" for="capSedeLegale">CAP sede legale *</label>
						</div>
						<div class="input-field col s6 m4 l6">
							<form:input type="text" id="indirizzoSedeLegale"
								path="indirizzoSedeLegale" cssClass="myRequired campiAz" required="required" maxlength="200" />
							<form:errors path="indirizzoSedeLegale" cssClass="error" />
							<label for="labelIndirizzoSedeLegale">Indirizzo sede legale (Es. Via Roma, 24)*</label>
						</div>
					</div>
					...
					<div class="hiddenField row col l12">
						<div class="input-field col s6 m4 l4">
							...
							<label for="labelTelefonoSedeLegale">Telefono sede legale (Es. 0245673467)</label>
						</div>
						<div class="input-field col s6 m4 l4">
							<form:input type="text" id="numCellulareSedeLegale"
								path="numCellulareSedeLegale" required="required" cssClass="campiAz"  maxlength="30" />
							<form:errors path="numCellulareSedeLegale" cssClass="error" />
							<label for="labelCellulareSedeLegale">Cellulare sede legale (Es. 3471234567)*</label>
						</div>
						<div class="input-field col s12 m8 l4">
							<form:input type="text" id="faxSedeLegale"
								path="faxSedeLegale" cssClass="campiAz" maxlength="30" />
							<form:errors path="faxSedeLegale" cssClass="error" />
							<label for="faxSedeLegale">Fax sede legale (Es. 0298765432)</label>
						</div>
					</div>
					...
					<div class="hiddenField row col l12">																		
						<div class="input-field col s6 m4 l6">
										...
										<label for="labelEmailSedeLegale">Email *</label>
						...
						<div class="input-field col s6 m4 l6">
										<form:input type="email" id="pecSedeLegale"
											cssClass="myRequired campiAz" path="pecSedeLegale" class="validate"
											 />
		     ...
		     <div class="card-panel">
	  				<div class="row">
	  					<p class="center-align"
								style="font-size: 20px; margin-bottom: 5px;">
								<em>L’Operatore Professionale dichiara l'intenzione di svolgere una o più attività
									indicate dal Reg. (UE) 2016/2031 art. 66.2.b-c, in qualità di:</em>
						</p>
	  				</div>
	  				<div class="row">
	  				...
	  				<div class="row" id="bloccoOperatoriCheckbox">
						<c:forEach var="voceCheckbox" items="${nuovaDomandaForm.vociCheckboxTipologia}">
							<div class="row">
								<div class=" col l12">
			...
			<div class="card-panel">
					...
					<div class="row" id="aggiungiAttivita">							
  					...
  					<div class="row col l6">	
           			...
           			<div class="row">
				        <table id="tabellaAttivita" class="data-table striped display" data-order='[[ 2, "asc" ]]'  data-paging="false" data-info="false">
				          <thead>
				            <tr>
				              ...
				              <c:choose>
				                 <c:when test="${attivita != null}">	 					             
									   <tr>																																	
										...
										<td style="white-spaces: nowrap" class="action">			 										
											<a href='javascript:modificaAttivitaMateriale(${attivita.idAttivitaMaterialeUtente})'
												class="btn btn-floating btn-floating-medium tooltipped light-green accent-3" 
												data-tooltip="Modificare attività">
							       ...
							       <c:otherwise>
							         <tr>
										<td nowrap style="white-spaces: nowrap" class="action">
											<sec:authorize access="hasRole('WRITE') ">																														
												  <a title="Elimina"
													onclick="javascript:eliminaTipologiaAttivita(this, ${attivita.idAttivitaMaterialeUtente})"
													class="btn btn-floating btn-floating-medium deep-orange accent-2">
				          ...
				          <tr id="rigaTemplateAttMateriali" style="display:none">	
							  ...
							  <td>
		          			  <td nowrap style="white-spaces: nowrap" class="action">			 										
								  	<a href='javascript:modificaAttivitaMateriale(PLACEHOLDER_idAttivitaMaterialeUtente)'
										class="btn btn-floating btn-floating-medium tooltipped light-green accent-3" 
										data-tooltip="Modificare attività">
										<i class="material-icons">mode_edit</i>
									</a>
			      	...
			      	<div class="row">	      
					 	<p style="font-size:15px;margin-bottom:5px;">
						  <em>Aggiungere la spunta se le attività inserite richiedono l'utilizzo del passaporto (obbligatorio per l'attività Vivaismo) </em>
						</p>  		
					   	<div id="divRichiestaPass" class=" col l6">
							<label>
								<form:checkbox id="richiestaPassaporto" path="richiestaPassaporto" />
								<span>Richiesta contestuale di autorizzazione al rilascio del Passaporto delle piante</span>
								<form:errors path="richiestaPassaporto" cssClass="error" />
							</label>						
						</div>						
					</div>			
				</div>
	...
	<content tag="script"> 
		...
		*/
		...
		function inizializePage(){
			...
			/*console.log('disabilito le select');
		...
		$(document).ready(function() {
			...
			var idStato = $("#idStatoComunicazione").val();
			if(idTipo == 3 && idStato == 1){
				disableAndHide();
			}
		});
...
// ****************  Gestione aggiungi attivita e materiali con modale ***********************
		...
		function salvaModificaAttivitaMateriali($form, idAttivitaMaterialeUtente, idTipoAttivita) {
			...
			console.log('salvaModificaAttivitaMateriali - idAttivitaMaterialeUtente: '+idTipoAttivita);
			if ($form.length == 0) {
				return;
			}
		...
		function aggiungiRigaAttMateriale(attivita, $rigaTemplate, $appendTo) {
			console.log('aggiungiRigaDettaglioDomanda');
