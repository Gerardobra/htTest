...
<body>
	...
	<div class="row">
		<div class="card col s12">
			<spring:url value="/export/richieste/elenco" var="formAction" />
			<form:form action="${formAction}" method="get"
              ...
              <label for="statoRichiesta">Stato richiesta</label>
						...
						<div class="input-field col s6 m4 l3">
							<form:select id="tipoRichiesta" path="codTipoRichiesta"
								cssClass="validate">
								<form:option value="" label="Selezionare" />
								<form:option value="EX" label="Export" />
								<form:option value="RI" label="Riexport" />
							</form:select>
							<form:errors path="codTipoRichiesta" cssClass="error" />
              ...
              <label for="provinciaMittente">Provincia Mittente</label>             
            </div>
	...
	<sec:authorize access="hasRole('WRITE') ">
		<div class="row">
			<a href='<spring:url value="/export/richieste/nuova"/>'
						...
						<tbody id="bodyTabellaRichieste">
							<c:forEach var="richiesta" items="${elencoRichieste}">
								<tr>
									...
									<td>${richiesta.descTipoRichiesta}</td>
									...
									<spring:url value="/export/richieste" var="richiesteAction" />
									<td nowrap style="white-spaces: nowrap"><a
										...
										<a href='<spring:url value="/export/report/richiesta/${richiesta.idRichiesta}"/>'
		...
		function checkElimina(link) {
			swal({
				  ...
				  html : 'Si desidera cancellare la richiesta numero <b>'
								+ $(link).closest('tr').find('td:nth-child(4)')
										.text() + '</b>?',
					type : 'warning',
