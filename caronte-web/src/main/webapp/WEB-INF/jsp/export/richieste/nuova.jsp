...
<body>
	...
	<div class="card row">
		...
		<div class="col s12" id="richiesta">
			<spring:url value="/export/richieste/nuova" var="formAction" />
				...
				<div class="card-content">
					...
					<div class="row">
						...
						<div class="input-field col s6 m4 l3">
							<form:select id="tipoRichiesta" path="idTipoRichiesta"
								cssClass="validate" required="required">
								<form:option value="" label="Selezionare" />
								<form:option value="${idTipoExport}" label="Export" />
								<form:option value="${idTipoRiexport}" label="Riexport" />
							</form:select>
						...
						<div id="bloccoCertificatoOriginale" class="input-field col s6 m4 l3">
              <form:input type='text' id="numeroCertificatoOriginale"
                path="numeroCertificatoOriginale" cssClass="validate tooltipped"
                data-value="${numeroCertificatoOriginale}" maxlength="23" 
				...
				<div class="card-action">
					<div class="row">
						...
						<button class="btn confirm waves-effect waves-light right "
							type="submit" name="datiRichiesta">SALVA</button>
					</div>
				</div>
			</form:form>
		</div>
		...
		<div class="col s12" id="trasporto">
			<form:form action="${formAction}" method="post"
              ...
              <form:input type="text" id="numDocumentoTrasporto" path="numDocumentoTrasporto"
                cssClass="validate" maxlength="30" />
              ...
              <label for="numDocumentoTrasporto">N. Identificativo mezzo trasporto</label>
						...
						<div class="input-field col s12 m8 l6">
              <form:textarea id="noteTrasporto" path="noteTrasporto" 
		...
		<div class="col s12" id="merce">
			<form:form id="formMerce" action="${formAction}" method="post"
				...
				<div class="card-content">
					<div class="row">
						...
						<div class="input-field col s6 m4 l3">
							...
							<input type="hidden" id="idGenereMerce" name="idGenereMerce"
              ...
              <input type="text" id="quantitaLordaMerce"
                name="quantitaLordaMerce" maxlength="10" /> 
            ...
            <div class="input-field col s6 m4 l3">
              <input type="text" id="quantitaMerce" name="quantitaMerce" maxlength="10" data-error="#errorTxt5" /> 
              ...
              <div id="errorTxt5" style="height: 0px"></div>
						...
						<div class="input-field col s6 m4 l3">
							<select id="naturaCollo" name="idNaturaCollo" data-error="#errorTxt6">
								<option value="">Selezionare</option>
						...
						<div class="input-field col s6 m4 l3">
							<input type="text" id="numeroColli" name="numeroColli" maxlength="7" data-error="#errorTxt7" /> 
                ...
                class="btn confirm waves-effect waves-light right">SALVA</button>
					...
					<div class="row">
								...
								<c:forEach var="merceRichiesta"
									...
									<tr>
										...
										<td>${merceRichiesta.descProdotto}
										  <form:input type="hidden" id="idProdotto"
												path="listaMerceRichiesta[${s.index}].idProdotto" /> 
											<form:input type="hidden" id="descProdotto"
                      ...
                      <form:input type="hidden" id="numeroPezzi" path="listaMerceRichiesta[${s.index}].numeroPezzi" />
										...
										<td>${merceRichiesta.descNaturaCollo}<form:input
												type="hidden" id="descNaturaCollo"
										...
										<td>${merceRichiesta.marchio}<form:input type="hidden"
												id="marchio" path="listaMerceRichiesta[${s.index}].marchio" />
			...
			<form:form id="formPagamento" action="${formAction}" method="post"
				...
				<div class="card-content">
					<div class="row">
						...
						<div class="input-field col s6 m4 l3">
							<form:input type='text' id="" path="dataPagamento" cssClass="datepicker" />
	...
	<script type="text/javascript"
		src='<spring:url value="/resources/js/dropify.min.js"/>'></script> <script>
			...
			$(document).ready(
				function() {
					...
					if ($('#tipoRichiesta').val() == "3") {
						$('#riexport-fields').show();
						$('#bloccoCertificatoOriginale').show();
					}else {
						$('#bloccoCertificatoOriginale').hide();
						$('#riexport-fields').hide();
					}

					$('#tipoRichiesta').change(function() {
						if ($(this).val() == "3") {
							$('#riexport-fields').fadeIn();
							$('#bloccoCertificatoOriginale').fadeIn();
						}else {
							$('#riexport-fields').fadeOut();
							$('#bloccoCertificatoOriginale').fadeOut();
						}
					});
      ...
      function caricaSpecieGenere() {    	  
        ...
        console.log('chiamata a setValoreAsincrono - getDatiDenomGenere');
        setValoreAsincrono(
          'idGenereMerce',
        ...
        console.log('chiamata a getSelectAsincrona - getListaSpecieDenomGenere');
