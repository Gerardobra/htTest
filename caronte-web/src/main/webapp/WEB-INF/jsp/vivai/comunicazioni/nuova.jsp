...
<body>
	...
	<!-- div class="row" -->
		<div class="card">
			<div class="card-header bg-primary-color white-text">
				<h3 class="card-title text-shadow uppercase-title title-padding"><b>NUOVA COMUNICAZIONE</b></h3>
			</div>
			
			<div class="card-content row">
				<div class="col s12">
					<div class="card-panel hoverable"><h6>Si sta creando una nuova Comunicazione, selezionare il Tipo di Comunicazione che si desidera inserire.</h6></div>
				</div>
	...
	<content tag="script"> 
		...
		function selezionaTipoComunicazione(idTipoComunicazione) {
			...
			swal({
				title : 'Si desidera creare una Comunicazione '+ descTipoComunicazione + '?',
				html : istruzioni,
				type : 'warning',
			  ...
			  if (result.value) {
				  window.location.href = '<spring:url value="/vivai/comunicazioni/anagrafica/nuova/"/>' + idTipoComunicazione;
			  }
          });
		}
