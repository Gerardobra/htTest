...
public class DumpUtils {
  ...
  public static void dump(int recursionDepth, XMLStreamWriter writer, Object obj, String name)
  ...
  private static boolean isPrimitive(Object obj) {
    return obj instanceof Number || obj instanceof CharSequence || obj instanceof java.util.Date ||
  ...
  public static void dump(int recursionDepth, XMLStreamWriter writer, ILoggable obj, String name)
      throws XMLStreamException {
    if (recursionDepth > MAX_RECURSION) {
      writeMaxRecursionException(writer);
      return;
