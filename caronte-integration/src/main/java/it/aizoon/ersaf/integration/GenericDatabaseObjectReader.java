...
class GenericDatabaseObjectReader<T> {
  ...
  protected static final Map<String, Map<String, Method>> OBJECTS_CACHEMAP =
...
System.out.println("\n\nCOLUMN NAME: "+metaData.getColumnName(idx));
System.out.println("\n\nSETTER: "+setter);
    try {
                        ...
                        if (double.class == paramType) {
                          ...
                          if (Float.class == paramType) {
                            ...
                            if (float.class == paramType) {
                              ...
                              if (Blob.class == paramType || byte.class == paramType ||
